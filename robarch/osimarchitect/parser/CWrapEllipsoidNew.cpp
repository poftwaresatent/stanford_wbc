...
/*!
 \author     Samir Menon
 \file       CWrapEllipsoidNew.cpp (provides a template for an ellipsoid wrap)
 */
//=========================================================================
...
CWrapEllipsoidNew::CWrapEllipsoidNew(void) {
}
 ...
 */
//===========================================================================
bool CWrapEllipsoidNew::loadWrapEllipsoidObject(TiXmlElement* pSimmBodyElement) {
  ...
  while (levelNineChildElement != NULL) {//Loop iterates over level9 child elements <mass>...<mass_center>...<inertia>
    ...
    else if (strcmp(levelNineChildTag, "dimensions") == 0) {
      str = levelNineChildElement->FirstChild()->Value();
      sscanf(str, "%lf %lf %lf", &temp0, &temp1, &temp2);
      dimensions.values(temp0, temp1, temp2);
      loadFlag = true;
    }
