...
//  ---------------------- Doxygen info ----------------------
//! \fn void ProfileStep2V_To_Vmax(double *CurrentPosition, double *CurrentVelocity, const double &MaxVelocity, const double &MaxAcceleration, double *ElapsedTime,	const bool &SignsAreInverted, TypeIOTGMath::TypeIMotionPolynomials *P)
//!
...
//  ---------------------- Doxygen info ----------------------
//! \fn void ProfileStep2V_To_Zero(double *CurrentPosition, double *CurrentVelocity, const double &MaxAcceleration, double *ElapsedTime, const bool &SignsAreInverted, TypeIOTGMath::TypeIMotionPolynomials *P)
//!
//! \brief Calculates the polynomial parameters to bring the velocity
//! value to zero
//!
...
//  ---------------------- Doxygen info ----------------------
//! \fn void ProfileStep2PosTrap(double *CurrentPosition, double *CurrentVelocity, const double &MaxAcceleration, const double &TargetPosition, const double &SynchronizationTime, double *ElapsedTime, const bool &SignsAreInverted, TypeIOTGMath::TypeIMotionPolynomials *P)
//!
...
//  ---------------------- Doxygen info ----------------------
//! \fn void ProfileStep2NegHldNegLin(double *CurrentPosition, double *CurrentVelocity, const double &MaxAcceleration, const double &TargetPosition, const double &SynchronizationTime, double *ElapsedTime, const bool &SignsAreInverted, TypeIOTGMath::TypeIMotionPolynomials *P)
//!
